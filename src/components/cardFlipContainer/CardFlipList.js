...
const CardFlipList = ({listItems, restart}) => {
    ...
    const renderListItems = ({item, index}) => {
        ...
        return(
            <View style={{ padding: 5}} testID="view-card-flip-item">
    ...
    return(
        <View style={styles.container} testID="view-card-flip-container">
            <View style={styles.headerContainer} >
                <Text testID="step-count-text">Step Count: {stepCount}</Text>
                <Button testID="restart-button" title="Restart" onPress={() => handleRestart()} />
            </View>
            <FlatList
